    ...
    <main>
      ...
      <section className="py-20 bg-white text-[#222831] font-poppins">
        ...
        <div className="container mt-16 mx-auto px-6 max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          {/* Left Column - Video */}
          <ScrollAnimation className="overflow-hidden shadow-lg rounded-2xl">
      ...
      <section className="py-20 bg-[#f0f0f0] text-[#222831] font-poppins">
        ...
        <div className="container mx-auto px-6 max-w-6xl mt-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
          {[
            { src: "/aboutus/about_1(pr.joyson).jpg", alt: "About 1" },
            { src: "/aboutus/aboutus_2.jpg", alt: "About 2" },
            { src: "/aboutus/aboutus_3.jpg", alt: "About 3" },
            { src: "/aboutus/aboutus_4.jpg", alt: "About 4" },
          ].map((img, idx) => (
        ...
        <div className="container mx-auto px-6 max-w-5xl">
          ...
          <div className="relative">
            ...
            <div className="mb-12 flex flex-col md:flex-row items-center md:justify-between relative">
              {/* Left Text Card */}
              <ScrollAnimation className="md:w-5/12 text-right pr-4 md:pr-8">
              ...
              {/* Right Image */}
              <ScrollAnimation className="md:w-5/12 mt-4 md:mt-0">
                <Image
            ...
            <div className="mb-12 flex flex-col md:flex-row items-center md:justify-between relative">
              {/* Left Image */}
              <ScrollAnimation className="md:w-5/12 md:order-1 order-2 mt-4 md:mt-0">
                <Image
              ...
              {/* Right Text Card */}
              <ScrollAnimation className="md:w-5/12 md:order-2 order-1 text-left pl-4 md:pl-8">
                <div className="bg-white rounded-xl shadow-md p-5 hover:shadow-lg transition duration-300">
